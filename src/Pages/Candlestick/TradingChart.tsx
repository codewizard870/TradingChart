...
const TradingChart: FunctionComponent<Props> = ({ initialData }) => {
  ...
  const candlesAppearance = {
    wickStroke: (d: any) => (d.close > d.open ? "#0ecc83": "#fa3c58" ),
    fill: (d: any) => (d.close > d.open ? "#0ecc83": "#fa3c58" ),
    stroke: (d: any) => (d.close > d.open ? "#0ecc83": "#fa3c58" ),
    candleStrokeWidth: 1,
    widthRatio: 0.8,
    opacity: 1,
  }
    ...
    >
      <Chart id={3} height={chartHeight} yExtents={candleChartExtents}  >
        ...
        <OHLCTooltip
          ...
          textFill={(d: any) => (d.close > d.open ? "#0ecc83": "#fa3c58" )}
        />
      </Chart>
      <CrossHairCursor />
    </ChartCanvas>
